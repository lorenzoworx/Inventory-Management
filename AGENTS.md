...
See docs/roadmap.md for scope and docs/learning-notes.md for the current lesson. Questions and tasks live in questions.md; the latest lesson is docs/lessons/05-purchasing.md.
