...
export function App() {
  ...
  return (
    <div className="page">
        ...
        <section className="connection-card" aria-labelledby="connection-title">
          ...
          <div className="connection-body">
            <div className="connection-description">
              ...
              <p className="scope-note">This checks the API process. Database checks come in the next milestone.</p>
            </div>
      ...
      <footer><span>Uba Inventory</span><span>Next up: products, categories & SQL.</span></footer>
    </div>
  );
}
